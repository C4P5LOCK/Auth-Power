                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            @if(Auth::user()->unreadNotifications->count() > 0)
                                <span class="absolute -top-2 -right-3 bg-red-500 text-white text-xs rounded-full px-2">
                        ...
                        <div
                            ...
                            class="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-lg border border-slate-200 z-50 p-4"
                        >
                            ...
                            @forelse(Auth::user()->unreadNotifications()->latest()->take(5)->get() as $notification)
                                <div class="text-sm text-slate-700 border-b py-2">
